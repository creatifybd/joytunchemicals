    ...
    <div className="admin-login min-h-screen flex items-center justify-center px-4"
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
        ...
        <button onClick={handleLogin} disabled={loading}
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3.5 font-bold text-gray-700 hover:bg-gray-50 transition-all disabled:opacity-60">
          {loading
        ...
        <p className="text-[11px] text-gray-400 mt-5">Admin access only. Unauthorized access will be rejected.</p>
